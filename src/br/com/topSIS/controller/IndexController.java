...
public class IndexController {
	...
	public IndexController(Result result, UsuarioComponente usuarioComponente, FuncionarioDAO funcionarioDAO) {
       this.result = result;
	...
	public void form(String login, String password) throws ParseException {
		Funcionario funcionario = funcionarioDAO.findByLoginAndPassword(login, Util.getInstance().crypt(password));
	}
}
